...
<head>
  ...
  <title>GEGE TRANSPORT - Index</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        <h1><a href="index.html">GEGE TRANSPORT</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="https://search.google.com/local/writereview?placeid=ChIJ3dpnt_5Uei4Rv_Ly_opa9n4">Testimonials</a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>GEGE <span>TRANSPORT</span></h1>
            ...
            <div class="info-wrap">
              <div class="row">
                <div class="col-lg-4 info">
                  ...
                  <h4>Location:</h4>
                  <p>Jl. Makam Raja, Paduresan, Imogiri, Kec. Imogiri, Kabupaten Bantul<br>Daerah Istimewa Yogyakarta 55782</p>
                </div>
